    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דור אלומיניום משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '31b5a126-1ce4-4e47-96f1-3ff36ce8adf5',
                    name: data.name || '',
                    email: data.email || '',
